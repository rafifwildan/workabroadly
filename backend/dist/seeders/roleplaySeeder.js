...
const RoleplayScenario_1 = __importDefault(require("../models/RoleplayScenario"));
...
async function seed() {
    try {
        ...
        for (const scenario of scenarios) {
            const result = await RoleplayScenario_1.default.updateOne({ title: scenario.title }, // cari berdasarkan title
