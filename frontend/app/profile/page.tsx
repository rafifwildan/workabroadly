                ...
                <div className="soft-card rounded-2xl bg-white shadow-lg p-8">
                  ...
                  <div className="flex items-center gap-6 mb-8 pb-8 border-b border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">Member since October 2025</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border-2 border-gray-300 bg-gray-50 p-3 focus:border-teal-500 focus:outline-none"
                      />
                    </div>
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          onChange={handleInputChange}
                          className="flex-1 rounded-xl border-2 border-gray-300 bg-gray-50 p-3 focus:border-teal-500 focus:outline-none"
                        />
            ...
            {activeTab === "account" && (
              <>
                ...
                <div className="soft-card rounded-2xl bg-red-50 border-l-4 border-red-500 p-6">
                  ...
                  <button className="rounded-xl bg-red-600 text-white px-6 py-2 hover:bg-red-700 transition-colors">
                    Delete Account
                  </button>
                </div>
              </>
